...
IS_MIXED_32_64_BIT_BUILD: Final = sys.platform in ["darwin"] and sys.version_info < (
    3,
    6,
)
...
#       Python 3.5 on macOS.
MAX_LITERAL_SHORT_INT: Final = (
    MAX_SHORT_INT if not IS_MIXED_32_64_BIT_BUILD else 2**30 - 1
)

        ...
        if isinstance(actual, Instance):
            ...
            if self.direction == SUBTYPE_OF and template.type.has_base(
                ...
                if instance.type.has_type_var_tuple_type:
                    mapped_prefix, mapped_middle, mapped_suffix = split_with_instance(
                        mapped
                    )
                    instance_prefix, instance_middle, instance_suffix = (
                        split_with_instance(instance)
                    )
                        ...
                        if isinstance(instance_unpack, TypeVarTupleType):
                            ...
                            if len(instance_unpack.items) == len(mapped_middle):
                                for instance_arg, item in zip(
                                    ...
                                    res.extend(
                                        infer_constraints(
                                            instance_arg, item, self.direction
                                        )
                                    )
                ...
                for tvar, mapped_arg, instance_arg in zip(
                    ...
                    if isinstance(tvar, TypeVarType):
                        ...
                        if isinstance(suffix, Parameters) or isinstance(
                            suffix, CallableType
                        ):
                        ...
                        if isinstance(template_unpack, TypeVarTupleType):
                            ...
                            if len(template_unpack.items) == len(mapped_middle):
                                for template_arg, item in zip(
                                    ...
                                    res.extend(
                                        infer_constraints(
                                            template_arg, item, self.direction
                                        )
                                    )

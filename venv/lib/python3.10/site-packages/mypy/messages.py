...
class MessageBuilder:
    ...
    def variable_may_be_undefined(self, name: str, context: Context) -> None:
        self.fail(
            f'Name "{name}" may be undefined', context, code=codes.PARTIALLY_DEFINED
        )
    ...
    def warn_operand_was_from_union(
        ...
        self.note(
            f"{side} operand is of type {format_type(original)}",
            context,
            code=codes.OPERATOR,
        )
    ...
    def invalid_signature_for_special_method(
        ...
        self.fail(
            f'Invalid signature {format_type(func_type)} for "{method_name}"', context
        )
    ...
    def redundant_cast(self, typ: Type, context: Context) -> None:
        self.fail(
            f"Redundant cast to {format_type(typ)}", context, code=codes.REDUNDANT_CAST
        )
    ...
    def typeddict_context_ambiguous(
        ...
        self.fail(
            f"Type of TypedDict is ambiguous, could be any of ({formatted_types})",
            context,
        )
    ...
    def typeddict_key_cannot_be_deleted(
        ...
        if typ.is_anonymous():
            ...
            self.fail(
                f'Key "{item_name}" of TypedDict {format_type(typ)} cannot be deleted',
                context,
            )
    ...
    def report_protocol_problems(
        ...
        *,
        ...
        conflict_types = get_conflict_protocol_types(
            subtype, supertype, class_obj=class_obj
        )

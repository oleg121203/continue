...
class Widget(tkinter.Widget):
    def __init__(
        self, master: tkinter.Misc | None, widgetname, kw: Incomplete | None = ...
    ) -> None: ...
...
class Panedwindow(Widget, tkinter.PanedWindow):
    def __init__(
        ...
        *,
        ...
        orient: Literal[
            "vertical", "horizontal"
        ] = ...,  # can't be changed with configure()
        style: str = ...,
        takefocus: tkinter._TakeFocusValue = ...,
        width: int = ...,
    ) -> None: ...
...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    def __init__(
        ...
        *,
        ...
        cursor: tkinter._Cursor = ...,
        displaycolumns: (
            str | list[str] | tuple[str, ...] | list[int] | tuple[int, ...]
        ) = ...,
        height: int = ...,
        name: str = ...,
        padding: _Padding = ...,
    ...
    if sys.version_info >= (3, 8):
        ...
        def selection(
            self, selop: Incomplete | None = ..., items: Incomplete | None = ...
        ) -> tuple[str, ...]: ...
    ...
    def tag_bind(
        ...
        tagname: str,
        sequence: str | None = ...,
        callback: Callable[[tkinter.Event[Treeview]], object] | None = ...,
    ) -> str: ...
    @overload

...
_TakeFocusValue: TypeAlias = Union[
...
class Misc:
    ...
    @overload
    def after(
        self, ms: int | Literal["idle"], func: Callable[..., object], *args: Any
    ) -> str: ...
    ...
    def winfo_atom(
        self, name: str, displayof: Literal[0] | Misc | None = ...
    ) -> int: ...
    def winfo_atomname(
        self, id: int, displayof: Literal[0] | Misc | None = ...
    ) -> str: ...
    ...
    @overload
    def bind(
        self, sequence: str | None, func: str, add: Literal["", "+"] | bool | None = ...
    ) -> None: ...
    @overload
    ...
    @overload
    def bind_all(
        self, *, func: str, add: Literal["", "+"] | bool | None = ...
    ) -> None: ...
    @overload
    def bind_class(
        self,
    ...
    @overload
    def bind_class(
        self, className: str, *, func: str, add: Literal["", "+"] | bool | None = ...
    ) -> None: ...
...
class Wm:
    ...
    def wm_focusmodel(
        self, model: Literal["active", "passive"] | None = ...
    ...
    group = wm_group
    def wm_iconbitmap(
        self, bitmap: Incomplete | None = ..., default: Incomplete | None = ...
    ): ...
    ...
    def wm_positionfrom(
        self, who: Literal["program", "user"] | None = ...
...
class Canvas(Widget, XView, YView):
    ...
    def tag_unbind(
        self, tagOrId: str | _CanvasItemId, sequence: str, funcid: str | None = ...
    ) -> None: ...
    ...
    def coords(
        self,
        __tagOrId: str | _CanvasItemId,
        __args: list[int] | list[float] | tuple[float, ...],
    ) -> None: ...
    @overload
    def coords(
        self, __tagOrId: str | _CanvasItemId, __x1: float, __y1: float, *args: float
    ) -> None: ...

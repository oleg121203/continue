...
def getmembers(
    object: object, predicate: _GetMembersPredicate | None = ...
) -> _GetMembersReturn: ...
...
if sys.version_info >= (3, 8):
    ...
    @overload
    def isgeneratorfunction(
        object: Callable[..., Generator[Any, Any, Any]]
    ) -> bool: ...
    @overload
    def isgeneratorfunction(
        object: Callable[_P, Any]
    ) -> TypeGuard[Callable[_P, GeneratorType[Any, Any, Any]]]: ...
    @overload
    def isgeneratorfunction(
        object: object,
    ...
    @overload
    def iscoroutinefunction(
        object: Callable[..., Coroutine[Any, Any, Any]]
    ) -> bool: ...
    @overload
    def iscoroutinefunction(
        object: Callable[_P, Awaitable[_T]]
    ) -> TypeGuard[Callable[_P, CoroutineType[Any, Any, _T]]]: ...
    @overload
    def iscoroutinefunction(
        object: Callable[_P, Any]
...
if sys.version_info >= (3, 10):
    ...
    def signature(
        obj: _IntrospectableCallable, *, follow_wrapped: bool = ...
    ) -> Signature: ...
...
class Signature:
    ...
    if sys.version_info >= (3, 10):
        ...
        @classmethod
        def from_callable(
            cls: type[Self], obj: _IntrospectableCallable, *, follow_wrapped: bool = ...
        ) -> Self: ...
...
def getcallargs(
    __func: Callable[_P, Any], *args: _P.args, **kwds: _P.kwargs
) -> dict[str, Any]: ...
...
def unwrap(
    func: Callable[..., Any], *, stop: Callable[[Callable[..., Any]], Any] | None = ...
) -> Any: ...

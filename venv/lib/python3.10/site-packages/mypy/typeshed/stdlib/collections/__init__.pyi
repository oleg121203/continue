...
class UserDict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(
        self: UserDict[str, _VT], __dict: None = ..., **kwargs: _VT
    ) -> None: ...
    @overload
...
class UserList(MutableSequence[_T]):
    ...
    def index(
        self, item: _T, __start: SupportsIndex = ..., __stop: SupportsIndex = ...
    ) -> int: ...
    # All arguments are passed to `list.sort` at runtime, so the signature should be kept in line with `list.sort`.
    @overload
    def sort(
        self: UserList[SupportsRichComparisonT], *, key: None = ..., reverse: bool = ...
    ) -> None: ...
    @overload
    def sort(
...
class UserString(Sequence[UserString]):
    ...
    if sys.version_info >= (3, 8):
        ...
        def encode(
            self: Self, encoding: str | None = ..., errors: str | None = ...
        ) -> Self: ...
    ...
    def replace(
        self: Self, old: str | UserString, new: str | UserString, maxsplit: int = ...
    ) -> Self: ...
...
class ChainMap(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def fromkeys(
        cls, iterable: Iterable[_T], __value: None = ...

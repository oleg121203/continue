...
_T = TypeVar("_T")
_FileRead: TypeAlias = (
    StrOrBytesPath | FileDescriptor | SupportsRead[bytes] | SupportsRead[str]
)
...
class Element:
    ...
    def __copy__(
        self,
    ) -> Element: ...  # returns the type of self in Python impl, but not in C impl
...
class ElementTree:
    def __init__(
        self, element: Element | None = ..., file: _FileRead | None = ...
    ) -> None: ...

...
if sys.version_info >= (3, 11):
    def fmean(
        data: Iterable[SupportsFloat], weights: Iterable[SupportsFloat] | None = ...
    ) -> float: ...
...
if sys.version_info >= (3, 11):
    def median_grouped(
        data: Iterable[SupportsFloat], interval: SupportsFloat = ...
    ) -> float: ...

else:
    def median_grouped(
        data: Iterable[_NumberT], interval: _NumberT = ...
    ) -> _NumberT | float: ...
...
if sys.version_info >= (3, 8):
    def quantiles(
        ...
        *,
        n: int = ...,
        method: Literal["inclusive", "exclusive"] = ...,
    ) -> list[_NumberT]: ...

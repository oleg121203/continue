...
class BaseEventLoop(AbstractEventLoop):
    ...
    def call_soon(
        self, callback: Callable[..., object], *args: Any, context: Context | None = ...
    ) -> Handle: ...
    def call_later(
        self,
        delay: float,
    ...
    if sys.version_info >= (3, 11):
        ...
        def create_task(
            self, coro: Coroutine[Any, Any, _T] | Generator[Any, None, _T]
        ) -> Task[_T]: ...
    ...
    if sys.version_info >= (3, 11):
        ...
        async def sock_recvfrom_into(
            self, sock: socket, buf: WriteableBuffer, nbytes: int = ...
        ) -> int: ...

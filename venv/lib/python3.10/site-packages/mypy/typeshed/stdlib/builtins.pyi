...
class int:
    ...
    @overload
    def __new__(
        cls: type[Self], __x: str | bytes | bytearray, base: SupportsIndex
    ) -> Self: ...
    if sys.version_info >= (3, 8):
...
class float:
    def __new__(
        cls: type[Self], x: SupportsFloat | SupportsIndex | str | ReadableBuffer = ...
    ) -> Self: ...
...
class complex:
    if sys.version_info >= (3, 8):
        ...
        def __new__(
            cls: type[Self],
            real: str | SupportsComplex | SupportsFloat | SupportsIndex | complex,
        ) -> Self: ...
    else:
        @overload
        def __new__(
        ...
        @overload
        def __new__(
            cls: type[Self], real: str | SupportsComplex | SupportsFloat | complex
        ) -> Self: ...
...
class str(Sequence[str]):
    ...
    @overload
    def __new__(
        cls: type[Self], object: ReadableBuffer, encoding: str = ..., errors: str = ...
    ) -> Self: ...
...
class bytes(ByteString):
    ...
    @overload
    def __new__(
        cls: type[Self], __string: str, encoding: str, errors: str = ...
    ) -> Self: ...
    @overload
    ...
    def ljust(
        self, __width: SupportsIndex, __fillchar: bytes | bytearray = ...
    ) -> bytes: ...
    def lower(self) -> bytes: ...
    def lstrip(self, __bytes: ReadableBuffer | None = ...) -> bytes: ...
    def partition(self, __sep: ReadableBuffer) -> tuple[bytes, bytes, bytes]: ...
    def replace(
        self, __old: ReadableBuffer, __new: ReadableBuffer, __count: SupportsIndex = ...
    ) -> bytes: ...
    if sys.version_info >= (3, 9):
    ...
    def rsplit(
        self, sep: ReadableBuffer | None = ..., maxsplit: SupportsIndex = ...
    ) -> list[bytes]: ...
    ...
    def translate(
        self, __table: ReadableBuffer | None, delete: bytes = ...
    ) -> bytes: ...
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    @overload
    def sort(
        self: list[SupportsRichComparisonT], *, key: None = ..., reverse: bool = ...
    ) -> None: ...
    @overload
    def sort(
...
@overload
def max(
    __iterable: Iterable[SupportsRichComparisonT], *, key: None = ...
) -> SupportsRichComparisonT: ...
@overload
def max(
...
@overload
def max(
    __iterable: Iterable[SupportsRichComparisonT], *, key: None = ..., default: _T
...
def print(
    *values: object,
    ...
    file: _SupportsWriteAndFlush[str] | None = ...,
    flush: bool,
) -> None: ...
...
if sys.version_info >= (3, 8):
    ...
    @overload
    def pow(
        base: float, exp: complex | _SupportsSomeKindOfPow, mod: None = ...
    ) -> Any: ...
    @overload
    def pow(
        base: complex, exp: complex | _SupportsSomeKindOfPow, mod: None = ...
    ) -> complex: ...
    @overload
    def pow(base: _SupportsPow2[_E, _T_co], exp: _E, mod: None = ...) -> _T_co: ...
    @overload
    def pow(
        base: _SupportsPow3NoneOnly[_E, _T_co], exp: _E, mod: None = ...
    ) -> _T_co: ...
    @overload
    ...
    @overload
    def pow(
        __base: float, __exp: complex | _SupportsSomeKindOfPow, __mod: None = ...
    ) -> Any: ...
    @overload
    def pow(
        __base: complex, __exp: complex | _SupportsSomeKindOfPow, __mod: None = ...
    ) -> complex: ...
    @overload
    def pow(
        __base: _SupportsPow2[_E, _T_co], __exp: _E, __mod: None = ...
    ) -> _T_co: ...
    @overload
    def pow(
        __base: _SupportsPow3NoneOnly[_E, _T_co], __exp: _E, __mod: None = ...
    ) -> _T_co: ...
    @overload
    def pow(
    ...
    @overload
    def pow(
        __base: _SupportsSomeKindOfPow, __exp: complex, __mod: None = ...
    ) -> complex: ...
...
if sys.version_info >= (3, 11):
    ...
    class BaseExceptionGroup(BaseException, Generic[_BaseExceptionT_co]):
        def __new__(
            cls: type[Self], __message: str, __exceptions: Sequence[_BaseExceptionT_co]
        ) -> Self: ...
        @property
    ...
    class ExceptionGroup(BaseExceptionGroup[_ExceptionT_co], Exception):
        def __new__(
            cls: type[Self], __message: str, __exceptions: Sequence[_ExceptionT_co]
        ) -> Self: ...
        @property
        def exceptions(
            self,

...
if sys.version_info >= (3, 10):
    ...
    @overload
    def format_exception(
        __exc: BaseException, *, limit: int | None = ..., chain: bool = ...
    ) -> list[str]: ...
...
def print_exc(
    limit: int | None = ..., file: SupportsWrite[str] | None = ..., chain: bool = ...
) -> None: ...
def print_last(
    limit: int | None = ..., file: SupportsWrite[str] | None = ..., chain: bool = ...
) -> None: ...
...
if sys.version_info >= (3, 11):
    class _ExceptionPrintContext:
        def indent(self) -> str: ...
        def emit(
            self, text_gen: str | Iterable[str], margin_char: str | None = ...
...
class TracebackException:
    ...
    if sys.version_info >= (3, 11):
        def format(
            self, *, chain: bool = ..., _ctx: _ExceptionPrintContext | None = ...
        ) -> Generator[str, None, None]: ...
    else:
    ...
    if sys.version_info >= (3, 11):
        def print(
            self, *, file: SupportsWrite[str] | None = ..., chain: bool = ...
        ) -> None: ...

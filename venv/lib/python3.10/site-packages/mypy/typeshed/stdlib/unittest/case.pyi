...
if sys.version_info >= (3, 8):
    def addModuleCleanup(
        __function: Callable[_P, Any], *args: _P.args, **kwargs: _P.kwargs
    ) -> None: ...
...
if sys.version_info >= (3, 10):
    _IsInstanceClassInfo: TypeAlias = Union[
...
class TestCase:
    ...
    def assertIsInstance(
        self, obj: object, cls: _IsInstanceClassInfo, msg: Any = ...
    ) -> None: ...
    ...
    def assertGreaterEqual(
        self, a: SupportsDunderGE[_T], b: _T, msg: Any = ...
    ) -> None: ...
    @overload
    def assertGreaterEqual(
        self, a: _T, b: SupportsDunderLE[_T], msg: Any = ...
    ) -> None: ...
    @overload
    ...
    @overload
    def assertLessEqual(
        self, a: SupportsDunderLT[_T], b: _T, msg: Any = ...
    ) -> None: ...
    @overload
    def assertLessEqual(
        self, a: _T, b: SupportsDunderGT[_T], msg: Any = ...
    ) -> None: ...
    ...
    def assertSetEqual(
        self, set1: AbstractSet[object], set2: AbstractSet[object], msg: Any = ...
    ) -> None: ...
    def assertDictEqual(
    ...
    if sys.version_info >= (3, 8):
        ...
        def addCleanup(
            self, function: Callable[_P, Any], *args: _P.args, **kwargs: _P.kwargs
        ) -> None: ...
    ...
    if sys.version_info >= (3, 8):
        @classmethod
        def addClassCleanup(
            cls, __function: Callable[_P, Any], *args: _P.args, **kwargs: _P.kwargs
        ) -> None: ...
        @classmethod
